<?php
    ...
    $qry_insert_tu301 = "DECLARE @LocationID int SET @LocationID = '".$LocationID."' "
                        ...
                        . "INSERT INTO #TU301 "
                        . "SELECT stxr.Alt_ID "
                        . "FROM [".$dbDatabase."].[dbo].[Tbl_Section_Master] AS scms INNER JOIN [".$dbDatabase."].[dbo].[Tbl_Course_Master] AS crms ON scms.Course_ID = crms.Course_ID "
                        . "INNER JOIN [".$dbDatabase."].[dbo].[Tbl_Student_Courses] AS stcr ON scms.Section_ID = stcr.Section_ID "
                        ...
                        . "INNER JOIN [".$dbDatabase."].[dbo].[Tbl_Button_Section_XRef] AS btsc ON scms.Section_ID = btsc.Section_ID "
                        . "INNER JOIN [".$dbDatabase."].[dbo].[Tbl_Button_Props] AS btpr ON btsc.Button_ID = btpr.Button_ID "
    ...
    $qry_insert_1 = "DECLARE @StartDate datetime SET @StartDate = '".$StartDate."' "
                        ...
                        . "FROM [".$dbDatabase."].[dbo].[Tbl_Student_History] AS sht INNER JOIN [".$dbDatabase."].[dbo].[Tbl_Grid_Current] AS gdc ON sht.Sched_ID = gdc.Sched_ID "
                        . "INNER JOIN [".$dbDatabase."].[dbo].[Tbl_Student_Master] AS stu ON stu.Student_ID = sht.Student_ID "
                        . "INNER JOIN [".$dbDatabase."].[dbo].[Tbl_Student_ID_XRef] AS sxf ON sxf.Student_ID = stu.Student_ID "
    ...
    $qry_insert_2 = "DECLARE @StartDate datetime SET @StartDate = '".$StartDate."' "
                        ...
                        . "FROM [".$dbDatabase."].[dbo].[Tbl_Student_History] AS sht INNER JOIN [".$dbDatabase."].[dbo].[Tbl_Student_ID_XRef] AS sxf ON sht.Student_ID = sxf.Student_ID "
                        . "INNER JOIN [".$dbDatabase."].[dbo].[Tbl_Student_Master] AS stu ON stu.Student_ID = sxf.Student_ID "
